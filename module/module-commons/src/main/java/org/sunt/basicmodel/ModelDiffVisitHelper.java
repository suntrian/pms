...
import static org.sunt.basicmodel.ModelDiffWrapper.State.*;
...
public class ModelDiffVisitHelper {
  ...
  private Map<Integer, BiConsumer<ModelDiffElement<Serializable>, ModelDiffElement<Serializable>>> preCreatedParentConsumer = new HashMap<>(initialSize);
  private Map<Integer, BiConsumer<ModelDiffElement<Serializable>, ModelDiffElement<Serializable>>> preDeletedParentConsumer = new HashMap<>(initialSize);
  private Map<Integer, BiConsumer<ModelDiffElement<Serializable>, ModelDiffElement<Serializable>>> preUpdatedParentConsumer = new HashMap<>(initialSize);
  private Map<Integer, BiConsumer<ModelDiffElement<Serializable>, ModelDiffElement<Serializable>>> preRemainParentConsumer = new HashMap<>(initialSize);
  private Map<Integer, BiConsumer<ModelDiffElement<Serializable>, ModelDiffElement<Serializable>>> postCreatedParentConsumer = new HashMap<>(initialSize);
  private Map<Integer, BiConsumer<ModelDiffElement<Serializable>, ModelDiffElement<Serializable>>> postDeletedParentConsumer = new HashMap<>(initialSize);
  private Map<Integer, BiConsumer<ModelDiffElement<Serializable>, ModelDiffElement<Serializable>>> postUpdatedParentConsumer = new HashMap<>(initialSize);
  private Map<Integer, BiConsumer<ModelDiffElement<Serializable>, ModelDiffElement<Serializable>>> postRemainParentConsumer = new HashMap<>(initialSize);
  ...
  private Map<Integer, VisitResult> reduceResult = new HashMap<>(initialSize);
  ...
  private static void removeCreateOrDeleteElement(List<ModelDiffElement<Serializable>> diffElements, ModelDiffWrapper.State state) {
    ...
    for (Iterator<ModelDiffElement<Serializable>> iterator = diffElements.iterator(); iterator.hasNext(); ) {
      ModelDiffElement<Serializable> element = iterator.next();
  ...
  private static void removeRemainElement(List<ModelDiffElement<Serializable>> diffElements) {
    if (diffElements == null || diffElements.isEmpty()) {
      return;
    }
    Iterator<ModelDiffElement<Serializable>> iterator = diffElements.iterator();
  ...
  //前序遍历树
  private VisitResult visitElements(List<ModelDiffElement<Serializable>> diffElements, int level) {
  ...
  public <U extends Serializable, V extends Serializable> ModelDiffVisitHelper setPreCreatedParentConsumer(final int level, BiConsumer<ModelDiffElement<U>, ModelDiffElement<V>> consumer) {
    this.preCreatedParentConsumer.put(level, (ModelDiffElement<Serializable> parent, ModelDiffElement<Serializable> child)
  ...
  public <U extends Serializable, V extends Serializable> ModelDiffVisitHelper setPreDeletedParentConsumer(final int level, BiConsumer<ModelDiffElement<U>, ModelDiffElement<V>> consumer) {
    this.preDeletedParentConsumer.put(level, (ModelDiffElement<Serializable> parent, ModelDiffElement<Serializable> child)
            -> consumer.accept((ModelDiffElement<U>) parent, (ModelDiffElement<V>) child));
    return this;
  }
  ...
  public <U extends Serializable, V extends Serializable> ModelDiffVisitHelper setPreUpdatedParentConsumer(final int level, BiConsumer<ModelDiffElement<U>, ModelDiffElement<V>> consumer) {
    this.preUpdatedParentConsumer.put(level, (ModelDiffElement<Serializable> parent, ModelDiffElement<Serializable> child)
            -> consumer.accept((ModelDiffElement<U>) parent, (ModelDiffElement<V>) child));
    return this;
  }
  ...
  public <U extends Serializable, V extends Serializable> ModelDiffVisitHelper setPreRemainParentConsumer(final int level, BiConsumer<ModelDiffElement<U>, ModelDiffElement<V>> consumer) {
    this.preRemainParentConsumer.put(level, (ModelDiffElement<Serializable> parent, ModelDiffElement<Serializable> child)
            -> consumer.accept((ModelDiffElement<U>) parent, (ModelDiffElement<V>) child));
    return this;
  }
  ...
  public <U extends Serializable, V extends Serializable> ModelDiffVisitHelper setPostCreatedParentConsumer(final int level, BiConsumer<ModelDiffElement<U>, ModelDiffElement<V>> consumer) {
    this.postCreatedParentConsumer.put(level, (ModelDiffElement<Serializable> parent, ModelDiffElement<Serializable> child)
            -> consumer.accept((ModelDiffElement<U>) parent, (ModelDiffElement<V>) child));
    return this;
  }
  ...
  public <U extends Serializable, V extends Serializable> ModelDiffVisitHelper setPostDeletedParentConsumer(final int level, BiConsumer<ModelDiffElement<U>, ModelDiffElement<V>> consumer) {
    this.postDeletedParentConsumer.put(level, (ModelDiffElement<Serializable> parent, ModelDiffElement<Serializable> child)
            -> consumer.accept((ModelDiffElement<U>) parent, (ModelDiffElement<V>) child));
    return this;
  }
  ...
  public <U extends Serializable, V extends Serializable> ModelDiffVisitHelper setPostUpdatedParentConsumer(final int level, BiConsumer<ModelDiffElement<U>, ModelDiffElement<V>> consumer) {
    this.postUpdatedParentConsumer.put(level, (ModelDiffElement<Serializable> parent, ModelDiffElement<Serializable> child)
            -> consumer.accept((ModelDiffElement<U>) parent, (ModelDiffElement<V>) child));
    return this;
  }
  ...
  public <U extends Serializable, V extends Serializable> ModelDiffVisitHelper setPostRemainParentConsumer(final int level, BiConsumer<ModelDiffElement<U>, ModelDiffElement<V>> consumer) {
    this.postRemainParentConsumer.put(level, (ModelDiffElement<Serializable> parent, ModelDiffElement<Serializable> child)
            -> consumer.accept((ModelDiffElement<U>) parent, (ModelDiffElement<V>) child));
    return this;
  }
